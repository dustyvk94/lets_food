...
const watcher = () => {
  ...
  watch(paths.vendors.watch, media).on('all', browserSync.reload)
}

const build = series(clean, parallel(vendors, favicon, images, sprite, fonts, pugs, scss, scripts, media))
